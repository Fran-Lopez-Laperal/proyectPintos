      ...
      <section>
        ...
        <article className="w-full flex justify-center mb-10 lg:mb-52">
          <section className="w-60  h-24 lg:w-auto lg:h-auto  flex flex-col items-center relative top-[-50px] lg:top-[1030px]">
            <p
              className="z-10 w-0 h-0 lg:border-r-[80px] lg:border-t-[80px] lg:border-l-[80px] lg:border-b-[80px] border-r-[40px] border-l-[40px] border-t-[40px] border-b-[40px] border-solid   border-r-white border-t-white 
