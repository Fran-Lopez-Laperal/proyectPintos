...
export function HomeLinks() {
  ...
  return (
    <>
      <ul className={`m-4 grid grid-cols-2 gap-2 mt-[-55px] ${isLargeScreen ? 'hidden' : ''}`}>
      ...
      <ul className={`m-4 grid grid-cols-2 gap-2 mt-[-55px] lg:flex lg:justify-center lg:mt-[-100px] ${isLargeScreen ? '' : 'hidden'}`}>
