...
export function PlanearConstruir() {
    ...
    return (
        <>
            <main>
                <HeaderPages text={'PLANEAR E CONSTRUIR'} textSize={'lg:text-4xl'} textSizeR={'text-1xl'} image={planearHeader} />
            </main>
            ...
            <section className="flex flex-col px-8  items-center justify-center lg:bg-graycorporative-color bg-corporative-color3 mt-10 h-auto lg:h-[296px]">
                <article className="">
                    ...
                    <section className="lg:h-[126px]">
                        <p className="text-center font-bold text-xs mt-5 lg:text-xl">
            ...
            <section className="flex flex-col items-center justify-center bg-sustentabilidade-color mt-10 lg:h-[230px]">
                <article className="px-11 lg:px-60">
                    <section className=" text-center">
                        <p className="text-2xl font-bold lg:text-[64px]  text-corporative-color2 mt-7">
                            SUSTENTABILIDADE
                        </p>
                    </section>
            ...
            <section className="flex flex-col  items-center mt-10">
                <article className="">
                    <section className=" text-center">
                        <p className="text-2xl font-bold  text-corporative-color2 mt-7 lg:text-[64px]">
                            CERTIFICAÇÕES
                        </p>
                    </section>
                    <article className="px-10 lg:h-[90px] flex flex-col items-center">
                        ...
                        <p className="text-center  font-bold text-xs lg:text-xl">
            ...
            <section className="mt-10 lg:mt-40">
                <section className="px-7 flex w-full items-center justify-center text-center mt-10 bg-corporative-color3 h-[49px] lg:h-[110px]">
                    <p
                        className="w-full text-2xl font-bold text-corporative-color2 lg:text-6xl border-b-[1px]  lg:border-b-[4px] border-corporative-color2">
                        PRÉMIOS
                    </p>
                ...
                <article className="h-full mb-16 lg:mb-0">
                    ...
                    <article className="px-5 lg:px-10">
                        <p className="text-justify text-sm   mt-10">
                            Nos nossos projetos e negócios propomo-nos garantir qualidade, inovação e excelência, respeitando os clientes,
